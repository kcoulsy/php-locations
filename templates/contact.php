					...
					<div class="row pt-4 mb-4">
						...
						<div class="col-lg-4 col-lg-offset-1">
							...
							<ul class="list list-icons mt-4 mb-4">
								<li><i class="icon-pin icons"></i> <strong>Address:</strong><p class="text-4 mb-0"><?php echo $address_line_1; ?><br>
								<?php echo $address_line_2; ?><br>
								<?php echo $address_line_3; ?><br>
								<?php echo $address_line_4; ?>
								</p>
							</li>
								<li><i class="icon-call-end icons"></i> <strong>Phone:</strong><p class="text-4 mb-0"><?php echo $phone_landline;?></p></li>
