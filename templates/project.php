...
<div class="body">
    ...
    <section class="page-header page-header-modern page-header-background bg-color-dark p-relative z-index-1 lazy-load-loaded" data-plugin-lazyload="" data-original="img/demos/digital-agency-2/bg/page-header-bg.jpg" style="background-image: url(&quot;img/demos/digital-agency-2/bg/page-header-bg.jpg&quot;); animation-duration: 1s;">
        ...
        <div class="container">
            <div class="row mt-5">
                <div class="col">
                    <h1 class="custom-text-10 font-weight-bolder">Our Work</h1>
                </div>
            </div>
        </div>
    </section>
						...
						<div class="col-lg-4">
							<div class="thumb-gallery">
								<div class="lightbox" data-plugin-options="{'delegate': 'a', 'type': 'image', 'gallery': {'enabled': true}}">
									...
									<div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 2520px;"><div class="owl-item active" style="width: 350px; margin-right: 10px;"><div>
											<a href="<?php echo $base_url ?>libs/images/placeholder.jpg">
												<span class="thumb-info thumb-info-centered-info thumb-info-no-borders text-4">
													<span class="thumb-info-wrapper text-4">
														<img alt="Project Image" src="<?php echo $base_url ?>libs/images/placeholder.jpg" class="img-fluid">
								...
								<div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 639px;"><div class="owl-item active" style="width: 76.25px; margin-right: 15px;"><div>
										<img alt="Project Image" src="<?php echo $base_url ?>libs/images/placeholder.jpg" class="img-fluid cur-pointer">
...
<?php include_once 'includes/get-in-touch-main.php'; ?>
